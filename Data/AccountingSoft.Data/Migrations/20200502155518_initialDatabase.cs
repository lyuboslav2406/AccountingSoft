        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EIK = table.Column<string>(maxLength: 9, nullable: false),
                    DDS = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoldProductId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    SoldQty = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_SoldProductId",
                table: "Products",
                column: "SoldProductId",
                unique: true,
                filter: "[SoldProductId] IS NOT NULL");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Products_SoldProducts_SoldProductId",
                table: "Products",
                column: "SoldProductId",
